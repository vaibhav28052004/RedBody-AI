      ...
      <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
        <div className="relative">
          {user.imageUrl ? (
            ...
            <div className="w-24 h-24 rounded-lg bg-gradient-to-br from-red-500/30 to-secondary/30 flex items-center justify-center">
        ...
        <div className="flex-1">
          ...
          <div className="h-px w-full bg-gradient-to-r from-red-500 via-secondary to-red-500 opacity-50 my-2"></div>
