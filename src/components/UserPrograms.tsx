      ...
      <div className="container mx-auto max-w-6xl px-4">
          ...
          <div className="p-8 text-center">
            ...
            <div className="flex items-center justify-center gap-16 mt-10 font-mono">
              <div className="flex flex-col items-center">
                <p className="text-3xl text-red-500">500+</p>
              ...
              <div className="flex flex-col items-center">
                <p className="text-3xl text-red-500">3min</p>
                <p className="text-sm text-muted-foreground uppercase tracking-wide mt-1">
                  CREATION TIME
                </p>
              </div>
              <div className="w-px h-12 bg-border"></div>
              <div className="flex flex-col items-center">
                <p className="text-3xl text-red-500">100%</p>
                <p className="text-sm text-muted-foreground uppercase tracking-wide mt-1">
                  PERSONALIZED
                </p>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {USER_PROGRAMS.map((program) => (
            <Card
              key={program.id}
              className="bg-card/90 backdrop-blur-sm border border-border hover:border-red-500/50 transition-colors overflow-hidden"
            >
              {/* Card header with user info */}
              <div className="flex items-center justify-between px-4 py-2 border-b border-border bg-background/70">
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 rounded-full bg-red-500"></div>
                  <span className="text-sm text-red-500">USER.{program.id}</span>
                </div>
              ...
              <CardHeader className="pt-6 px-5">
                ...
                <div className="flex justify-between items-center gap-4">
                  <div className="px-3 py-1 bg-red-500/10 rounded border border-red-500/20 text-sm text-red-500 flex items-center gap-2">
              ...
              <CardFooter className="px-5 py-4 border-t border-border">
                <Link href={`/programs/${program.id}`} className="w-full">
                  <Button className="w-full bg-red-500 text-red-100 hover:bg-red-500/90">
        ...
        <div className="mt-16 text-center">
          <Link href="/generate-program">
            <Button
              size="lg"
              className="bg-red-500 text-red-100 hover:bg-red-500/90 px-8 py-6 text-lg"
            >
