                ...
                <Button
                  ...
                  className={`text-foreground border hover:text-white ${
                    selectedPlanId === plan._id
                      ...
                      : "bg-transparent border-border hover:border-red-500/50"
                  }`}
                >
                  {plan.name}
                  {plan.isActive && (
                        ...
                        >
                          <AccordionTrigger className="px-4 py-3 hover:no-underline hover:bg-primary/10 font-mono">
                            <div className="flex justify-between w-full items-center">
                              <span className="text-red-500">{exerciseDay.day}</span>
                                ...
                                >
                                  <div className="flex justify-between items-start mb-2">
                                    ...
                                    <div className="flex items-center gap-2">
                                      <div className="px-2 py-1 rounded bg-red-500/20 text-red-500 text-xs font-mono">
                                        {routine.sets} SETS
                                      </div>
                      ...
                      {currentPlan.dietPlan.meals.map((meal, index) => (
                        ...
                        >
                          <div className="flex items-center gap-2 mb-3">
                            ...
                            <h4 className="font-mono text-red-500">{meal.name}</h4>
                          </div>
